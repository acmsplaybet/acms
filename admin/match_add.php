        ...
        function submitMatch(returnToList) {
            ...
            .then(res => {
                ...
                if (returnToList) {
                    ...
                    // Art arda hızlı giriş için akışı kesmeyen toast bildirimi
                    Swal.fire({
                        toast: true,
                        position: 'top-end',
                        icon: 'success',
    ...
    <div class="col-xl-8">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Maç Bilgileri</h4>
                <p class="card-title-desc">Bültene yeni bir maç veya tahmin ekleyin.</p>
            </div>
            <div class="card-body">
                <form id="matchForm">
                    ...
                    <div class="alert alert-info py-2 small mb-3" role="alert">
                        <i class="bx bx-bulb align-middle me-1"></i>
                        <strong>Hızlı Ekleme:</strong> "Kaydet" butonu maçı kaydeder, formu temizler ve seçili uygulamaları koruyarak art arda maç girmenizi sağlar.
                    </div>

                    <div class="d-flex flex-wrap gap-2 mt-3">
                        <button type="submit" class="btn btn-primary waves-effect waves-light" id="submitBtn">Kaydet ve Yeni Ekle</button>
