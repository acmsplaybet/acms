...
$app = [];
if ($app_id > 0) {
    $stmt = $db->prepare("SELECT a.*, b.name as brand_name, b.default_theme as brand_default_theme FROM apps a LEFT JOIN brands b ON b.id = a.brand_id WHERE a.id = ? AND a.is_deleted = 0");
    $stmt->execute([$app_id]);
    $app = $stmt->fetch(PDO::FETCH_ASSOC) ?: [];
}
$legalTexts = json_decode($app['legal_texts_json'] ?? '{}', true) ?: [];
...
<head>
    <meta charset="utf-8" />
    <title>Uygulama Düzenle | ACMS</title>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">Uygulama Düzenle</h4>
                            <div class="page-title-right d-flex gap-2">
                                <a href="../app/index.html?app_id=<?= $app_id ?>&preview=1" target="_blank" class="btn btn-info text-white">
                                    <i class="bx bx-show me-1"></i> Uygulamayı Görüntüle
                                </a>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form id="appEditForm">
                                    ...
                                    <input type="hidden" name="id" value="<?= $app_id > 0 ? $app_id : '' ?>">
                                    ...
                                    <div class="tab-content p-3 text-muted">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <select class="form-select" name="brand_id" required>
                                                        ...
                                                        <option value="<?= $brand['id'] ?>" <?= ($app['brand_id'] ?? '') == $brand['id'] ? 'selected' : '' ?>><?= htmlspecialchars($brand['name']) ?></option>
                                                        <?php endforeach; ?>
                                                    </select>
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="slug" name="slug" value="<?= htmlspecialchars($app['slug'] ?? '') ?>" required>
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label" for="frontend_url">Frontend URL</label>
                                                    <input type="text" class="form-control" id="frontend_url" name="frontend_url" value="<?= htmlspecialchars($app['frontend_url'] ?? '') ?>">
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label" for="app_type">App Tipi</label>
                                                    <select class="form-select" id="app_type" name="app_type">
                                                        <option value="free" <?= ($app['app_type'] ?? '') === 'free' ? 'selected' : '' ?>>Free</option>
                                                        <option value="paid" <?= ($app['app_type'] ?? '') === 'paid' ? 'selected' : '' ?>>Paid</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label" for="price">Fiyat ($)</label>
                                                    <input type="number" step="0.01" class="form-control" id="price" name="price" value="<?= htmlspecialchars($app['price'] ?? '0.00') ?>">
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 mb-3">
                                                    ...
                                                    <select class="form-select" id="theme" name="theme">
                                                        ...
                                                        <option value="<?= $tv ?>" <?= ($app['theme'] ?? 'real') === $tv ? 'selected' : '' ?>><?= $tl ?></option>
                                                        <?php endforeach; ?>
                                                    </select>
                                                </div>
                                                <div class="col-md-3 mb-3">
                                                    <label class="form-label" for="primary_color">Primary Color</label>
                                                    <input type="color" class="form-control form-control-color w-100" id="primary_color" name="primary_color" value="<?= htmlspecialchars($app['primary_color'] ?? '#5156be') ?>">
                                                </div>
                                                <div class="col-md-3 mb-3">
                                                    <label class="form-label" for="secondary_color">Secondary Color</label>
                                                    <input type="color" class="form-control form-control-color w-100" id="secondary_color" name="secondary_color" value="<?= htmlspecialchars($app['secondary_color'] ?? '#333333') ?>">
                                                </div>
                                                <div class="col-md-3 mb-3">
                                                    <label class="form-label" for="accent_color">Accent Color</label>
                                                    <input type="color" class="form-control form-control-color w-100" id="accent_color" name="accent_color" value="<?= htmlspecialchars($app['accent_color'] ?? '#ffcc00') ?>">
                                                </div>
                                                <div class="col-md-3 mb-3">
                                                    <label class="form-label" for="bg_color">BG Color</label>
                                                    <input type="color" class="form-control form-control-color w-100" id="bg_color" name="bg_color" value="<?= htmlspecialchars($app['bg_color'] ?? '#ffffff') ?>">
                                                </div>
                                                ...
                                                <div class="col-md-12 mb-3">
                                                    ...
                                                    <select class="form-select" id="font_family" name="font_family">
                                                        ...
                                                        <option value="<?= $f ?>" <?= ($app['font_family'] ?? '') === $f ? 'selected' : '' ?>><?= $f ?></option>
                                                        <?php endforeach; ?>
                                                    </select>
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <?php if(!empty($app['logo_url'])): ?><img src="../<?= htmlspecialchars($app['logo_url']) ?>" height="30" class="mt-2"><?php endif; ?>
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <?php if(!empty($app['favicon_url'])): ?><img src="../<?= htmlspecialchars($app['favicon_url']) ?>" height="20" class="mt-2"><?php endif; ?>
                                                </div>
                                                <div class="col-md-12 mb-3">
                                                    <label class="form-label" for="play_store_link">Play Store Linki</label>
                                                    <input type="text" class="form-control" id="play_store_link" name="play_store_link" value="<?= htmlspecialchars($app['play_store_link'] ?? '') ?>">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="tab-pane" id="tab-contact" role="tabpanel">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="url" class="form-control mb-1" id="contact_telegram" name="contact_telegram" value="<?= htmlspecialchars($app['contact_telegram'] ?? '') ?>">
                                                    <input type="text" class="form-control" id="contact_telegram_response" name="contact_telegram_response" placeholder="Yanıt Süresi Örn: 1 Saat" value="<?= htmlspecialchars($app['contact_telegram_response'] ?? '') ?>">
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label" for="contact_whatsapp">WhatsApp (Tel)</label>
                                                    <input type="text" class="form-control mb-1" id="contact_whatsapp" name="contact_whatsapp" value="<?= htmlspecialchars($app['contact_whatsapp'] ?? '') ?>">
                                                    <input type="text" class="form-control" id="contact_whatsapp_response" name="contact_whatsapp_response" placeholder="Yanıt Süresi" value="<?= htmlspecialchars($app['contact_whatsapp_response'] ?? '') ?>">
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label" for="contact_instagram">Instagram (URL)</label>
                                                    <input type="url" class="form-control mb-1" id="contact_instagram" name="contact_instagram" value="<?= htmlspecialchars($app['contact_instagram'] ?? '') ?>">
                                                    <input type="text" class="form-control" id="contact_instagram_response" name="contact_instagram_response" placeholder="Yanıt Süresi" value="<?= htmlspecialchars($app['contact_instagram_response'] ?? '') ?>">
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label" for="contact_email">Email</label>
                                                    <input type="email" class="form-control mb-1" id="contact_email" name="contact_email" value="<?= htmlspecialchars($app['contact_email'] ?? '') ?>">
                                                    <input type="text" class="form-control" id="contact_email_response" name="contact_email_response" placeholder="Yanıt Süresi" value="<?= htmlspecialchars($app['contact_email_response'] ?? '') ?>">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="tab-pane" id="tab-ux" role="tabpanel">
                                            <div class="row">
                                                <div class="col-md-4 mb-3">
                                                    <div class="form-check form-switch mt-4">
                                                        <input class="form-check-input" type="checkbox" id="welcome_modal_active" name="welcome_modal_active" value="1" <?= ($app['welcome_modal_active'] ?? 0) == 1 ? 'checked' : '' ?>>
                                                ...
                                                <div class="col-md-4 mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="welcome_modal_title" id="welcome_modal_title" 
                                                           value="<?= htmlspecialchars($app['welcome_modal_title'] ?? 'Important Notice') ?>" placeholder="Örn: Güncelleme & Önemli Duyuru">
                                                </div>
                                                <div class="col-md-4 mb-3">
                                                    ...
                                                    <select class="form-select" name="welcome_modal_frequency" id="welcome_modal_frequency">
                                                        <option value="daily" <?= ($app['welcome_modal_frequency'] ?? 'daily') === 'daily' ? 'selected' : '' ?>>Günde 1 Kez</option>
                                                        <option value="always" <?= ($app['welcome_modal_frequency'] ?? '') === 'always' ? 'selected' : '' ?>>Her Açılışta</option>
                                                        <option value="once" <?= ($app['welcome_modal_frequency'] ?? '') === 'once' ? 'selected' : '' ?>>Sadece İlk Açılışta (1 Kez)</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-12 mb-3">
                                                    <label class="form-label" for="welcome_modal_text">Welcome Modal Metni</label>
                                                    <textarea class="form-control" id="welcome_modal_text" name="welcome_modal_text" rows="2"><?= htmlspecialchars($app['welcome_modal_text'] ?? '') ?></textarea>
                                                ...
                                                <div class="col-md-12 mb-3">
                                                    ...
                                                    <textarea class="form-control" id="home_announcement_text" name="home_announcement_text" rows="2"><?= htmlspecialchars($app['home_announcement_text'] ?? '') ?></textarea>
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <textarea class="form-control" id="post_register_text" name="post_register_text" rows="2"><?= htmlspecialchars($app['post_register_text'] ?? '') ?></textarea>
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <textarea class="form-control" id="empty_state_text" name="empty_state_text" rows="2"><?= htmlspecialchars($app['empty_state_text'] ?? '') ?></textarea>
                                                ...
                                                <div class="col-md-12 mb-3">
                                                    ...
                                                    <textarea class="form-control" id="vip_hub_description" name="vip_hub_description" rows="2"><?= htmlspecialchars($app['vip_hub_description'] ?? '') ?></textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4 mb-3">
                                                    <input type="text" class="form-control mb-2" id="onboarding_step1_title" name="onboarding_step1_title" placeholder="Step 1 Title" value="<?= htmlspecialchars($app['onboarding_step1_title'] ?? '') ?>">
                                                    <input type="text" class="form-control" id="onboarding_step1_desc" name="onboarding_step1_desc" placeholder="Step 1 Desc" value="<?= htmlspecialchars($app['onboarding_step1_desc'] ?? '') ?>">
                                                </div>
                                                <div class="col-md-4 mb-3">
                                                    <input type="text" class="form-control mb-2" id="onboarding_step2_title" name="onboarding_step2_title" placeholder="Step 2 Title" value="<?= htmlspecialchars($app['onboarding_step2_title'] ?? '') ?>">
                                                    <input type="text" class="form-control" id="onboarding_step2_desc" name="onboarding_step2_desc" placeholder="Step 2 Desc" value="<?= htmlspecialchars($app['onboarding_step2_desc'] ?? '') ?>">
                                                </div>
                                                <div class="col-md-4 mb-3">
                                                    <input type="text" class="form-control mb-2" id="onboarding_step3_title" name="onboarding_step3_title" placeholder="Step 3 Title" value="<?= htmlspecialchars($app['onboarding_step3_title'] ?? '') ?>">
                                                    <input type="text" class="form-control" id="onboarding_step3_desc" name="onboarding_step3_desc" placeholder="Step 3 Desc" value="<?= htmlspecialchars($app['onboarding_step3_desc'] ?? '') ?>">
                                                </div>
                                            </div>
                                            <hr>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4 mb-3">
                                                    <input type="text" class="form-control" id="guide_step_1" name="guide_step_1" placeholder="Step 1" value="<?= htmlspecialchars($app['guide_step_1'] ?? '') ?>">
                                                </div>
                                                <div class="col-md-4 mb-3">
                                                    <input type="text" class="form-control" id="guide_step_2" name="guide_step_2" placeholder="Step 2" value="<?= htmlspecialchars($app['guide_step_2'] ?? '') ?>">
                                                </div>
                                                <div class="col-md-4 mb-3">
                                                    <input type="text" class="form-control" id="guide_step_3" name="guide_step_3" placeholder="Step 3" value="<?= htmlspecialchars($app['guide_step_3'] ?? '') ?>">
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="card border border-primary bg-soft-primary mb-0">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-check form-switch mb-3">
                                                                <input class="form-check-input" type="checkbox" id="enable_haptic" name="enable_haptic" value="1" <?= ($app['enable_haptic'] ?? 1) == 1 ? 'checked' : '' ?>>
                                                            ...
                                                            <div class="mb-2">
                                                                ...
                                                                <select class="form-select" id="haptic_intensity" name="haptic_intensity">
                                                                    <option value="light" <?= ($app['haptic_intensity'] ?? 'light') === 'light' ? 'selected' : '' ?>>Hafif (Light - 15ms) • Tavsiye Edilen</option>
                                                                    <option value="medium" <?= ($app['haptic_intensity'] ?? '') === 'medium' ? 'selected' : '' ?>>Orta (Medium - 30ms)</option>
                                                                    <option value="heavy" <?= ($app['haptic_intensity'] ?? '') === 'heavy' ? 'selected' : '' ?>>Güçlü (Heavy - 60ms)</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-md-6 mb-4">
                                                    <div class="card border border-info bg-soft-info mb-0">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-check form-switch mb-3">
                                                                <input class="form-check-input" type="checkbox" id="keep_screen_awake" name="keep_screen_awake" value="1" <?= ($app['keep_screen_awake'] ?? 1) == 1 ? 'checked' : '' ?>>
                                        ...
                                        <div class="tab-pane" id="tab-rateus" role="tabpanel">
                                            ...
                                            <div class="row">
                                                <div class="col-md-3 mb-3">
                                                    <div class="form-check form-switch mt-4">
                                                        <input class="form-check-input" type="checkbox" id="rate_us_active" name="rate_us_active" value="1" <?= ($app['rate_us_active'] ?? 0) == 1 ? 'checked' : '' ?>>
                                                ...
                                                <div class="col-md-3 mb-3">
                                                    ...
                                                    <input type="number" class="form-control" id="rate_us_snooze_days" name="rate_us_snooze_days" value="<?= htmlspecialchars($app['rate_us_snooze_days'] ?? '3') ?>">
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label" for="rate_us_reward">Ödül</label>
                                                    <input type="text" class="form-control" id="rate_us_reward" name="rate_us_reward" value="<?= htmlspecialchars($app['rate_us_reward'] ?? '') ?>">
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label" for="rate_us_title">Başlık</label>
                                                    <input type="text" class="form-control" id="rate_us_title" name="rate_us_title" value="<?= htmlspecialchars($app['rate_us_title'] ?? '') ?>">
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label" for="rate_us_text">Açıklama</label>
                                                    <input type="text" class="form-control" id="rate_us_text" name="rate_us_text" value="<?= htmlspecialchars($app['rate_us_text'] ?? '') ?>">
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label" for="rate_us_rate_btn_text">Puanla Butonu</label>
                                                    <input type="text" class="form-control" id="rate_us_rate_btn_text" name="rate_us_rate_btn_text" value="<?= htmlspecialchars($app['rate_us_rate_btn_text'] ?? '') ?>">
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label" for="rate_us_later_btn_text">Daha Sonra Butonu</label>
                                                    <input type="text" class="form-control" id="rate_us_later_btn_text" name="rate_us_later_btn_text" value="<?= htmlspecialchars($app['rate_us_later_btn_text'] ?? '') ?>">
                                                </div>
                                            </div>
                                            <hr>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="rate_us_step2_title" name="rate_us_step2_title" value="<?= htmlspecialchars($app['rate_us_step2_title'] ?? '') ?>">
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label" for="rate_us_step2_text">Step 2 Text</label>
                                                    <input type="text" class="form-control" id="rate_us_step2_text" name="rate_us_step2_text" value="<?= htmlspecialchars($app['rate_us_step2_text'] ?? '') ?>">
                                                </div>
                                                <div class="col-md-4 mb-3">
                                                    <label class="form-label" for="rate_us_step2_email_btn">Email Btn</label>
                                                    <input type="text" class="form-control" id="rate_us_step2_email_btn" name="rate_us_step2_email_btn" value="<?= htmlspecialchars($app['rate_us_step2_email_btn'] ?? '') ?>">
                                                </div>
                                                <div class="col-md-4 mb-3">
                                                    <label class="form-label" for="rate_us_step2_telegram_btn">Telegram Btn</label>
                                                    <input type="text" class="form-control" id="rate_us_step2_telegram_btn" name="rate_us_step2_telegram_btn" value="<?= htmlspecialchars($app['rate_us_step2_telegram_btn'] ?? '') ?>">
                                                </div>
                                                <div class="col-md-4 mb-3">
                                                    <label class="form-label" for="rate_us_step2_done_btn">Done Btn</label>
                                                    <input type="text" class="form-control" id="rate_us_step2_done_btn" name="rate_us_step2_done_btn" value="<?= htmlspecialchars($app['rate_us_step2_done_btn'] ?? '') ?>">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="tab-pane" id="tab-security" role="tabpanel">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4 mb-3">
                                                    <div class="form-check form-switch mt-4">
                                                        <input class="form-check-input" type="checkbox" id="maintenance_mode" name="maintenance_mode" value="1" <?= ($app['maintenance_mode'] ?? 0) == 1 ? 'checked' : '' ?>>
                                                        <label class="form-check-label" for="maintenance_mode">Bakım Modu</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-4 mb-3">
                                                    <div class="form-check form-switch mt-4">
                                                        <input class="form-check-input" type="checkbox" id="is_ios_allowed" name="is_ios_allowed" value="1" <?= ($app['is_ios_allowed'] ?? 0) == 1 ? 'checked' : '' ?>>
                                                        <label class="form-check-label" for="is_ios_allowed">iOS İzni Ver</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-4 mb-3">
                                                    <div class="form-check form-switch mt-4">
                                                        <input class="form-check-input" type="checkbox" id="forced_login" name="forced_login" value="1" <?= ($app['forced_login'] ?? 0) == 1 ? 'checked' : '' ?>>
                                                        <label class="form-check-label" for="forced_login">Zorunlu Giriş</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <div class="form-check form-switch mt-4">
                                                        <input class="form-check-input" type="checkbox" id="prevent_screenshot" name="prevent_screenshot" value="1" <?= ($app['prevent_screenshot'] ?? 1) == 1 ? 'checked' : '' ?>>
                                                ...
                                                <div class="col-md-3 mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="app_version" name="app_version" value="<?= htmlspecialchars($app['app_version'] ?? '1.0.0') ?>">
                                                </div>
                                                <div class="col-md-3 mb-3">
                                                    <label class="form-label" for="min_required_version">Min. Versiyon</label>
                                                    <input type="text" class="form-control" id="min_required_version" name="min_required_version" value="<?= htmlspecialchars($app['min_required_version'] ?? '1.0.0') ?>">
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <div class="form-check form-switch mt-4">
                                                        <input class="form-check-input" type="checkbox" id="is_force_update" name="is_force_update" value="1" <?= ($app['is_force_update'] ?? 0) == 1 ? 'checked' : '' ?>>
                                                ...
                                                <div class="col-md-12 mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="user_agent" name="user_agent" value="<?= htmlspecialchars($app['user_agent'] ?? '') ?>">
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label" for="guest_tips_limit">Guest Maç Limiti</label>
                                                    <input type="number" class="form-control" id="guest_tips_limit" name="guest_tips_limit" value="<?= htmlspecialchars($app['guest_tips_limit'] ?? '3') ?>">
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label" for="history_limit_days">Geçmiş Gün Gösterim Limiti</label>
                                                    <input type="number" class="form-control" id="history_limit_days" name="history_limit_days" value="<?= htmlspecialchars($app['history_limit_days'] ?? '10') ?>">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="tab-pane" id="tab-integrations" role="tabpanel">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="onesignal_app_id" name="onesignal_app_id" value="<?= htmlspecialchars($app['onesignal_app_id'] ?? '') ?>">
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label" for="onesignal_api_key">OneSignal API Key</label>
                                                    <input type="text" class="form-control" id="onesignal_api_key" name="onesignal_api_key" value="<?= htmlspecialchars($app['onesignal_api_key'] ?? '') ?>">
                                                </div>
                                                <div class="col-md-12 mb-3">
                                                    <label class="form-label" for="tawk_to_id">Tawk.to Property ID</label>
                                                    <input type="text" class="form-control" id="tawk_to_id" name="tawk_to_id" value="<?= htmlspecialchars($app['tawk_to_id'] ?? '') ?>">
                                                </div>
                                                <div class="col-md-12 mb-3">
                                                    <label class="form-label" for="appmetrica_key">
                                                        <i class="bx bx-bar-chart-alt-2 me-1 text-primary"></i> Yandex AppMetrica API / App Key
                                                    </label>
                                                    <input type="text" class="form-control font-monospace" id="appmetrica_key" name="appmetrica_key" value="<?= htmlspecialchars($app['appmetrica_key'] ?? '') ?>" placeholder="Örn: 7d7fd12a-02e2-4d54-98c5-09de6d1954e0">
                                                ...
                                                <div class="col-md-12 mb-3">
                                                    ...
                                                    <textarea class="form-control" id="custom_scripts" name="custom_scripts" rows="4"><?= htmlspecialchars($app['custom_scripts'] ?? '') ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="tab-pane" id="tab-legal" role="tabpanel">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 mb-3">
                                                    ...
                                                    <textarea class="form-control" id="privacy_policy" rows="5"><?= htmlspecialchars($legalTexts['privacy'] ?? '') ?></textarea>
                                                </div>
                                                <div class="col-md-12 mb-3">
                                                    <label class="form-label" for="terms_of_use">Terms of Use</label>
                                                    <textarea class="form-control" id="terms_of_use" rows="5"><?= htmlspecialchars($legalTexts['terms'] ?? '') ?></textarea>
                                                </div>
                                                <div class="col-md-12 mb-3">
                                                    <label class="form-label" for="about_us">About Us</label>
                                                    <textarea class="form-control" id="about_us" rows="4"><?= htmlspecialchars($legalTexts['about'] ?? '') ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="card-body text-center p-3">
                                ...
                                ">
                                    ...
                                    <iframe id="spa-preview-iframe" 
                                        src="../app/index.html?app_id=<?= $app_id > 0 ? $app_id : 1 ?>&preview=true" 
                                        style="
                                            width: 375px;
                                            height: 773px;
                                            border: none;
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const formInputs = document.querySelectorAll('#appEditForm input, #appEditForm select, #appEditForm textarea');
    ...
    // Form Submit (Sayfada Kalma & SweetAlert2 Toast)
            ...
            .then(res => {
                ...
                if (res.status === 'success') {
                    Swal.fire({
                        ...
                        position: 'top-end',
                        icon: 'success',
                        title: 'Uygulama ayarları başarıyla kaydedildi.',
